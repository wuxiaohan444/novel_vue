<template>
    <div id="advertising">
        ...
        <scroller class="adv-box" :on-infinite="loadMore" ref="my_scroller"
            ...
            <div class="adv-box-item" v-for="(item,index) in advList" :key="index" @click="skip(item.id)">
                <div class="adv-top">
...
<!--                    <div class="edit" @click="editAdv(item.id)"></div>-->
                    <div class="delete" @click.stop="deleteAdv(item.id)"></div>
                </div>
            </div>
        </scroller>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            oneGetList(){
                this.$axios('get', '/index.php?m=&c=Index&a=userArticle', {page: this.page,is_copy:1}, (res) => {
